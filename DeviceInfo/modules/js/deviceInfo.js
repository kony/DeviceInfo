...
function deviceInfo()
{
    ...
    {
      	details.push({lblKey:"Device ID",lblVal:""+kony.os.deviceInfo().deviceid});
      	details.push({lblKey:"Name",lblVal:""+kony.os.deviceInfo().name});
      	details.push({lblKey:"Model",lblVal:""+kony.os.deviceInfo().model});
      	details.push({lblKey:"APILevel",lblVal:""+kony.os.deviceInfo().APILevel});
      	details.push({lblKey:"Version",lblVal:""+kony.os.deviceInfo().version});
      	details.push({lblKey:"OS Version",lblVal:""+kony.os.deviceInfo().osversion});
